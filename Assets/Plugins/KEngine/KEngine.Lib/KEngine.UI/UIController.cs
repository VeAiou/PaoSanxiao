...
namespace KEngine.UI
{
    ...
    public class UIController : KBehaviour
    {
        ...
        /// 父窗口
        /// </summary>
        public UIController ParentWondow;
        /// <summary>
        /// 是否是子窗口
        /// </summary>
        ...
        /// 子窗口列表
        /// </summary>
        public List<UIController> ChildUI = new List<UIController>();
        /// <summary>
        /// 是否关闭销毁
        /// </summary>
        public bool IsCloseDestory = false;
        ...
        //注册消息
        public virtual void RegMessage()
        {
        }
        //移除消息
        public virtual void UnResMessage()
        {
        }
        ...
        protected void CloseChildWindow(string uiName)
        {
        ...
        public void CloseAllChildWindow()
        {
            ...
            {
                UIModule.Instance.CloseWindow(item.UIName);
            }
        }

        public void RemoveChildList(UIController ui)
        {
        ...
        public void AddChildList(UIController ui)
        {
            if(!ChildUI.Contains(ui))
            {
                ChildUI.Add(ui);
            }
        }
